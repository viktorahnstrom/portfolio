...
export default function Contact() {
  ...
  return (
    <section
      ...
      className={`min-h-screen relative py-16 md:py-24 overflow-hidden flex flex-col justify-center scroll-animate-scale ${sectionInView ? "in-view" : ""}`}
    >
      <FlowingTopography
        ...
        speed={0.85}
      />
      <div className="relative z-10 mx-auto px-6 md:px-12 lg:px-24 max-w-7xl w-full">
        <div
          ref={cardRef}
